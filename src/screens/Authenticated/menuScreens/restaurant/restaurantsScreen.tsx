...
const restaurantsData: IRestaurantData[] = [
  {
    id: 1,
    imgUri: 'https://hips.hearstapps.com/hmg-prod/images/classic-cheese-pizza-recipe-2-64429a0cb408b.jpg?crop=0.6666666666666667xw:1xh;center,top&resize=1200:*',
  ...
  {
    id: 2,
    imgUri: 'https://www.foodandwine.com/thmb/K_t1B_xBKIKYm_ZoNIEqaBvuXcQ=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Burger-King-Everything-Seasoned-Bun-FT-BLOG0922-c8c7859b9c794c42af7700b5b957a874.jpg',
    title: 'Burger King',
    street: 'Rruga Pjeter Budi',
    likes: 26,
    openTime: '5 PM - 11 PM',
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Restaurant Details', {item: item})}>
                      ...
                      <Box flexDir={'row'} alignItems={'center'}>
                        ...
                        <VStack paddingLeft={4}>
                          <Text fontSize={20} marginBottom={2}>{item.title}</Text>
                          <HStack>
                            <HStack>

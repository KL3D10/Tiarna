...
const hotspotsData: ICategoryData[] = [
    {
      id: 1,
      imgUri: "https://vizitoshqip.com/fileadmin/_processed_/3/f/csm_Sheshi-Skenderbeu4_6033e9e2cc.jpg",
      title: "Scanderbeg Square",
      street: "Sheshi Skenderbej",
      likes: 26,
      openTime: "5 PM - 11 PM",
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
      detailImgUri: "https://infokomuna.com/repository/images/main/13_03_2019_8132342_tirana2.jpg",
    ...
    },
    {
      id: 2,
      imgUri:
        "https://www.mywanderlust.pl/wp-content/uploads/2023/01/things-to-do-in-tirana-albania-171.jpg",
      title: "Kulla e Sahatit",
      street: "Sheshi Skenderbej",
      likes: 26,
      openTime: "5 PM - 11 PM",
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
      detailImgUri: "https://i0.wp.com/peizazhe.com/wp-content/uploads/2016/05/20160426_134003.jpg?fit=1200%2C787&ssl=1",
      phone: "+355 69 22 33 444",
      email: "testtest@gmail.com",
    },
    {
...
const HotspotsScreen = ({ navigation }: { navigation: any }) => {
  return (
<Box flex={1}>
